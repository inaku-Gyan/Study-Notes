...
\begin{theorem}[Variation of Parameters]
  ...
  \begin{equation*}
    u_i(t) = \int \frac{g(t) \cdot \det[M_i(t)]}{W(y_1, \ldots, y_n)(t)} \dd{t},
...
\begin{theorem}[Existence and Uniqueness]
  ...
  \(\bm{y}(t)\) for \(t \in (t_0 - h, t_0 + h)\) to the IVP,
  where
  \begin{equation*}
    h = \min \{a, b/M\} \qand
    M = \max\limits_{\bm{v} \in R}\{
      \abs{F_1(\bm{v})}, \abs{F_2(\bm{v})}, \ldots, \abs{F_n(\bm{v})}
    \}.
  \end{equation*}
\end{theorem}
...
\begin{definition}[First-Order Linear System]
  ...
  \begin{equation}
    \bm{y}'(t) = \bm{P}(t) \bm{y}(t) + \bm{g}(t) \quad \qfor t\in I,
...
\begin{definition}[Homogeneous First-Order Linear System]
  ...
  \(\bm{g}(t) = \bm{0}\) for all \(t\in I\), i.e., it can be expressed as
  \begin{equation*}
    \bm{y}'(t) = \bm{P}(t) \bm{y}(t) \quad \qfor t\in I.
  \end{equation*}
\end{definition}
...
\begin{theorem}[Existence and Uniqueness for First-Order Linear Systems]
  ...
  if all entries of \(\bm{P}(t)\) and \(\bm{g}(t)\) are continuous on
  an interval \(I\), then for any \(t_0 \in I\) and \(\bm{y}_0 \in
  \mathbb{R}^n\),
  there exists a unique solution \(\bm{y}(t)\) to the IVP
  \begin{equation*}
    \begin{cases}
      \bm{y}'(t) = \bm{P}(t) \bm{y}(t) + \bm{g}(t) \\
      \bm{y}(t_0) = \bm{y}_0
    \end{cases}
    \quad \qfor t\in I.
  \end{equation*}
