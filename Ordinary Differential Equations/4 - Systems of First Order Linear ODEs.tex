...
\begin{definition}[Homogeneous First-Order Linear System]
  ...
  \end{equation}
  where \(\vec{y} \in {C(I)}^n\) and \(\mat{P}(t) \in {C(I)}^{n \times n}\).
\end{definition}
...
\begin{theorem}[Principle of Superposition]
  ...
  \(\vec{y}'(t) = \mat{P}(t) \vec{y}(t)\), then the linear combination
  \begin{equation*}
...
\begin{theorem}
  ...
  \(\vec{y}'(t) = \mat{P}(t) \vec{y}(t)\) for \(t\in I\).
...
\begin{definition}[Fundamental Set of Solutions]
  ...
  to the homogeneous
  system \(\vec{y}'(t) = \mat{P}(t) \vec{y}(t)\) is called a
...
\begin{theorem}
  ...
  \(n\) solutions to
  a homogeneous system \(\vec{y}'(t) = \mat{P}(t) \vec{y}(t)\) for \(t\in I\),
  then
  \begin{equation*}
    \forall t\in I, \quad
