...
\begin{proof}
  ...
  Therefore, the essence of this proof is to show that the dimension
  of the solution space is exactly \(n\), so that \(n\)
  linearly independent solutions form a basis (FSS).
  Also, since the solution space is a subspace of \({C^1(I)}^n\),
  the dimension of the solution space cannot exceed \(n\).
  Hence, we only need to show that the dimension is at least \(n\).
